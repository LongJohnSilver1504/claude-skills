...
This repo is a Claude Code **plugin**: 26 skills, 6 agents, 5 hooks, and 19 seed rules forming a feature-development pipeline. Consumers install it and run `/setup-daher-skills` once per project.
